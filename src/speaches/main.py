...
# Default max_file_size in Starlette 0.40.0+ is 1MB (1024 * 1024 bytes)
# Increase to 100MB to support large audio file uploads
...
def create_app() -> FastAPI:
    ...
    if config.enable_ui:
        ...
        logger.info("\n" + "=" * 60)
        logger.info("🎤 Speaches - Speech-to-Text & Text-to-Speech API")
        logger.info("👨‍💻 Developed/Upgraded by: Gokay Yilmaz")
        logger.info("📦 Docker Hub: gokay/halkspeach")
        logger.info("=" * 60)
